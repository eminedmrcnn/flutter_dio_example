...
import 'package:flutter_dio_example/future_builder/model/http_cat_model.dart';
import 'package:flutter_dio_example/future_builder/model/user_model.dart';
import 'package:flutter_dio_example/future_builder/service/IFutureService.dart';
import 'package:flutter_dio_example/future_builder/service/future_service.dart';
import 'package:flutter_dio_example/future_builder/view/future_extension.dart';
...
class _FutureViewState extends State<FutureView>
  ...
  void initState() {
    ...
    http = futureService!.getHttpCatList(httpCatPath);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: httpUser!.toBuild<List<UserModel>>(onSucces: (data) {
